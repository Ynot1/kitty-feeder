...
extern bool catdetectedstate;
extern bool alexafeedflag;
extern bool catfeederloopstatus;
extern bool catfeederstabilitystatus;
extern bool catdetectedlatch;
extern bool timedfeedflag;
...
Switch::Switch(String alexaInvokeName, unsigned int port, CallbackFunction oncb, CallbackFunction offcb, bool AlexaIndicator){
    ...
    sprintf_P(uuid, PSTR("78323644-4668-3dda-9688-cda0e6%02x%02x%02x"),
  ...
  if(request.indexOf("GetBinaryState") >= 0) {
    if (DebugMessages == true) { 
      Serial.println("Got binary state request");
          Serial.println("its localPortis:");
    Serial.println(localPort);
    }
      ...
      switch (localPort) {
      case 90:
            switchStatus = alexafeedflag;
      break;
      case 91:
            switchStatus = timedfeedflag;
      break;
      case 92:
            switchStatus = catfeederloopstatus;
      break;
      case 93:
            switchStatus = catfeederstabilitystatus;
      break;
      case 94:
            switchStatus = catdetectedstate;
      break;
      case 95:
            switchStatus = catdetectedlatch;
      break;
      case 96:
            switchStatus = timedfeedflag;
  ...
  String setup_xml = "<?xml version=\"1.0\"?>"
            "<root>"
             "<device>"
                ...
                //original # "<serialNumber>221517K0101769</serialNumber>"
                "<serialNumber>271517K0101001</serialNumber>"
